...
class Category(models.Model): # Создадим модель для категории запроса к ChatGPT, наследуя свойства класса django.db.models.Model
    # Id не надо, он создается автоматически
    # для имени модели выбираем тип поля CharField с максимальной длиной символов 16 и делим его уникальным
...
class Post(models.Model): # Создадим класс постов
    ...
    # Добавляем дату создания поста и ее автозаполнение
