...
class RegistrationView(View):
    def get(self, request):
        ...
        return render(request, "../temp/appweb1/templates/../appweb1/templates/registration.html", {"users": users})
    ...
    def post(self, request):
        ...
        if request.method == "POST":
            if action == "register":
                ...
                user.save()
                messages.success(
                    request, "Информация о пользователе успешно обновлена."
                )
...
class LoginView(View):
    def get(self, request):
        return render(request, "../temp/appweb1/templates/../appweb1/templates/login.html")
    ...
    def post(self, request):
        if request.method == "POST":
            ...
            messages.error(
                request, "Неверный email или пароль. Пожалуйста, попробуйте снова."
            )
            return redirect("login")
